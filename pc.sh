...
cp $PROJECT_DIR/systemd-units/adjust_display_brightness_by_time.service         ~/.config/systemd/user/adjust_display_brightness_by_time.service
...
cp $PROJECT_DIR/systemd-units/adjust_display_brightness_on_login.service        ~/.config/systemd/user/adjust_display_brightness_on_login.service
